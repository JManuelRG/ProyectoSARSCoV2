...
def add_N(n,seq, k):
	# This method is called from gene_mod() method, for creating dummy nucleotide 'N'.
	dimension1 = numpy_image_dict[k][0][0]
	dimension2 = numpy_image_dict[k][0][1]
	full_length = dimension1 * dimension2
	actual_length = len(seq)
	n = full_length - actual_length
	for i in range(0,n):
		seq += 'N'
	return seq